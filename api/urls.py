...
urlpatterns = [
    ...
    path('educator-sessions/<int:educator_id>/', get_educator_sessions, name='get_educator_sessions'),
    path('learner-sessions/<int:learner_id>/', get_learner_sessions, name='get_learner_sessions'),
